...
admin=["ua9bc35c918832c32bb462d9ec18941c0","ua9bc35c918832c32bb462d9ec18941c0","ua9bc35c918832c32bb462d9ec18941c0"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Owner : line://ti/p/~ifdhol19",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~ifdhol19",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
            elif "Dol say " in msg.text:
				if msg.from_ in admin:
					bctxt = msg.text.replace("Dol say ","")
					ki.sendText(msg.to,(bctxt))
#-----------------------------------------------

            elif msg.text in ["Author","Creator"]:
				ki.sendText(msg.to,"line.me/ti/p/~ifdhol19")
